...
export const objList = [
    ...
    { component: 'ConeCrossFourSide', name: 'conecrossfourside', label: '形状b', thumbnail: './glb/thumbnail/shapeb.png' },
    { component: 'ConeCross', name: 'conecross', label: '圆锥穿插体', thumbnail: './glb/thumbnail/shapec.png' },
