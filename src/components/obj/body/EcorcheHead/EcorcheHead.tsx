...
const EcorcheHead: React.FC<Props> = ({ visible, opacity, showEdige, shadow, ...groups }) => {
    ...
    return (
        <group {...groups} >
            <Center position={[0,1.9,0.4]} rotation={[0,angleToRotation(0),0]}>
                <group position={[0, 8, 0]} rotation={[angleToRotation(90), angleToRotation(0), 0]} scale={0.5}>
                    <mesh
                        scale={2}
                        ...
                        position={[0, 0, 0]}
                        castShadow={shadow}
                        geometry={nodes.ecorche_head.geometry}
                        dispose={null}
                    >
