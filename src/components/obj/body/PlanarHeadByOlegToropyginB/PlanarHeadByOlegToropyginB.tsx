...
const PlanarHeadByOlegToropyginB: React.FC<Props> = ({
    visible,
    opacity,
    showEdige,
    shadow,
    ...
    const res = useGLTF(
        `${process.env.PUBLIC_URL || ''}/glb/body/planar_head_by_oleg_toropygin_b.glb`
    ) as any;
...
export default PlanarHeadByOlegToropyginB;
