...
const FemaleBodyMuscularSystem: React.FC<Props> = ({
    visible,
    opacity,
    showEdige,
    shadow,
    ...
    const { nodes } = useGLTF(
        ...
        }/glb/body/female_body_muscular_system.glb`
    ) as any;
        ...
        <group {...groups}>
            ...
            >
                <group
                    ...
                    scale={0.22}
                >
                    {nodes.female_skeleton_first_muscles_anatomy_studyOBJcleanergles.children.map(
