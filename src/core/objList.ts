...
export const objList = [
    ...
    {checkedlocked: true, component: 'body/MaleAntomy', name: 'male_antomy', label: '男性身体', thumbnail: './glb/thumbnail/body/male_antomy.png' },
    ...
    {checkedlocked: true, component: 'body/SpeedHeadAnatomy', name: 'speed_head_anatomy', label: '头像', thumbnail: './glb/thumbnail/body/speed_head_anatomy.png' },
